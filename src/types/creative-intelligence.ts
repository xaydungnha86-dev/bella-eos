...
export interface CreativeBrief {
  ...
  keyBenefits?: string[];        // 3 key benefits for bullet points (optional, generated by LLM or fallback)
  callToAction?: string;         // CTA button text (optional, generated by LLM or fallback)
